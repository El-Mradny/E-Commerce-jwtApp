...
export default function HomePublic() {
  ...
  return (
    <>
      <Carousel>
        <Carousel.Item as={Link} to={`/register`}>
          <img
        ...
        <Carousel.Item as={Link} to={`/register`}>
          <img
            className="d-block w-100"
            src="https://i.pinimg.com/originals/f7/bc/6b/f7bc6b674b91ef43c1a3e78b0f25eb4f.png"
            alt="Second slide"
          />
      ...
      <CardGroup>
        <Card style={{ borderColor: 'white', textAlign: 'center' }}>
          ...
          <Card.Body>
            ...
            <Button variant="outline-success" as={Link} to={`/register`}>Shop Now</Button>
            {/* productcategory */}
          </Card.Body>
      ...
      <>
        {
          products.slice(0, 4).map(product => <ProductShortPublic key={product.id} product={product} />)
        }
      </>
      ...
      <CardGroup>
        ...
        <Card style={{ borderColor: 'white' }}>
          <Card.Body>
            ...
            <Button variant="outline-success" as={Link} to={`/register`} >Discover</Button>
          </Card.Body>
        </Card>
      </CardGroup>
      ...
      <Button as={Link} to={`/register`}>View More Products</Button>
      ...
      <Button variant="light" as={Link} to={`/register`} style={{
