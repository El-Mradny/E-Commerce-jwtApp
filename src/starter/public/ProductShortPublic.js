...
export default function ProductShortPublic({ product }) {
        ...
        <Card border="success" style={{ width: '17rem', float: 'left', margin: '15px' }}>
          ...
          <Card.Footer>
            <Card.Text>
              ...
              <Button variant="outline-success" title="Details" style={{ margin: '3px' }} as={Link} to={`/register`}>Details</Button>
            </Card.Text>
          </Card.Footer>
        </Card>
      </div>
        ...
        <Card border="success" style={{ width: '17rem', float: 'left', margin: '15px' }}>
          ...
          <Card.Footer>
            <Card.Text>
              ...
              <Button title="Details" variant="outline-success" style={{ margin: '3px' }} as={Link} to={`/register`}>Details</Button>
            </Card.Text>
          </Card.Footer>
        </Card>
      </div>
